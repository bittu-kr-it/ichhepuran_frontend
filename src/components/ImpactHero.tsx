...
// Same minimal shape as AboutHero — no CTAs, no background photo, solid
// gradient banner (no source hero copy existed for the original Impact
// page, see ImpactPageSeeder's docblock for the drafted copy used here).
